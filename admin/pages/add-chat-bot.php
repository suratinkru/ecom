				...
				<div class="col-md-12">
					<div class="card">
						...
						<div class="card-body">
							...
							<form action="../controllers/chat-bot/add_chatbot.php" method="post" >
								<div class="row">
									<div class="col-sm-12">
										<div class="form-group ">
											<label>คำสำคัญ</label>
											<input id="messages" type="text" name="messages" class="form-control" placeholder="คำสำคัญ" required>
										</div>
									</div>
                                    <div class="col-sm-12">
										<div class="form-group ">
                                            ...
                                            <textarea name="response" class="form-control" rows="5"  placeholder="คำตอบ" required></textarea>
										</div>
									</div>
