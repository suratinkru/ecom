<?php session_start();
 ...
 //ถ้ามีค่าส่งมาจากฟอร์ม
    ...
    //check username  & password
      $stmt = $conn->prepare("SELECT id, username ,role FROM tbl_admin WHERE username = :username AND password = :password");
      ...
      if($stmt->rowCount() == 1){
       ...
       // exit();
          ...
          header('Location: ../../pages/index.php'); //login ถูกต้องและกระโดดไปหน้าตามที่ต้องการ
         ...
         echo '<script>
                       setTimeout(function() {
                        swal({
                            ...
                            window.location = "../../pages/login.php"; //หน้าที่ต้องการให้กระโดดไป
                        });
                      }, 1000);
                  </script>';
